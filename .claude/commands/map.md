...
- **If not found:** Announce "Mode B: Standalone mode - using bundled Reference Pack at ./braindrive-builder/reference-pack/PluginTemplate-REAL/"
...
Use the bundled Reference Pack at `./braindrive-builder/reference-pack/PluginTemplate-REAL/`
