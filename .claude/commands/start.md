...
- **If NOT found:** Mode B (Standalone): Use bundled Reference Pack at `./braindrive-builder/reference-pack/PluginTemplate-REAL/`
...
- **Mode B (Standalone):** If no BrainDrive folder is present, I'll use the bundled Reference Pack at `./braindrive-builder/reference-pack/PluginTemplate-REAL/`
